...
<?php
  if(isset($_POST['gravar'])) {
    ...
    if(!$erro) {
      try {
        $sql = "INSERT into fornecedores(NomeCompanhia, NomeContato, TItuloContato, Endereco, Cidade, cep, Pais, Telefone, Regiao, Fax, Website)
                      values(:NomeCompanhia, :NomeContato, :TItuloContato, :Endereco, :Cidade, :cep, :Pais, :Telefone, :Regiao, :Fax, :Website)";
